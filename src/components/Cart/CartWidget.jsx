...
export default function CartWidget({CartWidgetStatus,handleOpenCart}) {
  const {
    isEmpty,
    totalUniqueItems,
    items,
  ...
  return (
    !isEmpty && CartWidgetStatus &&  
    <Dialog open={CartWidgetStatus} onClose={handleOpenCart} className="relative z-10">
      <DialogBackdrop
        transition
